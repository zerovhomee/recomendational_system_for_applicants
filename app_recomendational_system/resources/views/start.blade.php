...
<header>
    <div class="container">
        <div class="header-content">
            <span class="header-text">Система рекомендаций для абитуриентов</span>
        </div>
    </div>
</header>
<main>
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="swiper-slide-container">
                        <div class="swiper-slide-text-container">
                            ...
                            <span class="swiper-slide-text">Жизнь современного человека сложно представить без электронных
                  устройств. Все гаджеты и многие вещи повседневного быта, которые ждут нас дома после работы или
                ...
                <div class="swiper-slide">
                  ...
                  потоки информации, создавать поисковые системы, сети хранения, обработки и передачи информации.</span>
                            <span class="swiper-slide-text">Проходной балл в 2024<br><br>
                ...
                <div class="swiper-slide">
                  ...
                  информации, проводит разъяснительные беседы с сотрудниками, чтобы они не делали
                  глупостей в Интернете.</span>
                            <span class="swiper-slide-text">Проходной балл в 2024<br><br>
                ...
                <div class="swiper-slide">
                    <div class="swiper-slide-container">
                        <div class="swiper-slide-text-container">
                            ...
                            <span class="swiper-slide-number">09.03.01</span>
                            <span class="swiper-slide-text">Знаете ли Вы значение терминов «матрица путаницы»,
                  «горячее кодирование», «случайный лес» и «переобучение»? Специалисты в области развития
                  искусственного интеллекта и наши студенты регулярно имеют дело с этими, на первый взгляд,
                  необычными терминами. Их значение и применение на практике изучается в рамках современной
    ...
    <div class="container">
        <div class="main-text-container">
            <span class="main-text-title">Кратко про наш проект:</span>
            <span class="main-text">Мы разработали платформу, которая помогает абитуриентам находить образовательные
          программы ИРИТ-РТФ УрФУ, идеально соответствующие их интересам и способностям. Искусственный интеллект
          анализирует данные, полученные в ходе интерактивного тестирования, где вы рассказываете о своих увлечениях,
          навыках и жизненных целях.<br>На основе этих ответов система сравнивает ваш потенциал с примерами успешных
          студентов института и предлагает рекомендации, учитывающие как ваши сильные стороны, так и скрытые
          возможности. Этот подход исключает необходимость долгого перебора вариантов, экономя время и снижая риск
          ошибки при выборе вуза.<br>Платформа особенно полезна для тех, кто сомневается в своих силах или ищет
          подтверждение правильности своего пути.<br>ИРИТ-РТФ УрФУ — это среда, где создаются технологии будущего,
          а наш инструмент помогает стать частью этого процесса, направляя к программам в сфере IT, робототехники,
          цифровых инноваций и других перспективных направлений.<br>Зарегистрируйтесь на сайте, пройдите короткий
          тест и узнайте, какие программы станут вашим первым шагом к осознанной и вдохновляющей карьере.</span>
        </div>
    </div>

    <div class="container">
        <div class="button-container">
            <a class="button" href="{{ route('test') }}">Пройти тест</a>
        </div>
    </div>
